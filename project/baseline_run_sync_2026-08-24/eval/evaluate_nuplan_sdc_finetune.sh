...
# Evaluate one completed synced-baseline nuPlan SDC fine-tune on all final benchmarks.
#
# Usage:
#   CUDA_VISIBLE_DEVICES=0 ./project/baseline_run_sync_2026-08-24/eval/evaluate_nuplan_sdc_finetune.sh 0
#   CUDA_VISIBLE_DEVICES=1 DRY_RUN=1 ./project/baseline_run_sync_2026-08-24/eval/evaluate_nuplan_sdc_finetune.sh 1
