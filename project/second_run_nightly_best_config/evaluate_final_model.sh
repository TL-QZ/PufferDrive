...
# Evaluate one completed seed on the full CARLA and nuPlan benchmarks.
# Metrics are written below the checkpoint run and attached to its W&B run.
#
# Usage:
#   CUDA_VISIBLE_DEVICES=0 ./project/second_run_nightly_best_config/evaluate_final_model.sh 0
#   CUDA_VISIBLE_DEVICES=1 ./project/second_run_nightly_best_config/evaluate_final_model.sh 1
#   CUDA_VISIBLE_DEVICES=0 DRY_RUN=1 ./project/second_run_nightly_best_config/evaluate_final_model.sh 2
