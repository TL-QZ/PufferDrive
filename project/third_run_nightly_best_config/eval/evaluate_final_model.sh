...
# Evaluate one completed third-run CARLA seed on CARLA and both nuPlan modes.
#
# Usage:
#   CUDA_VISIBLE_DEVICES=0 ./project/third_run_nightly_best_config/eval/evaluate_final_model.sh 0
#   CUDA_VISIBLE_DEVICES=1 DRY_RUN=1 ./project/third_run_nightly_best_config/eval/evaluate_final_model.sh 1
