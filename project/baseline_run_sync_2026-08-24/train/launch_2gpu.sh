...
# Train one synced-baseline CARLA/Gigaflow seed on exactly two GPUs.
#
# Usage:
#   ./project/baseline_run_sync_2026-08-24/train/launch_2gpu.sh 0
#   CUDA_VISIBLE_DEVICES=4,5 ./project/baseline_run_sync_2026-08-24/train/launch_2gpu.sh 1
#   DRY_RUN=1 ./project/baseline_run_sync_2026-08-24/train/launch_2gpu.sh 2
...
RUN_NAME_PREFIX="baseline_run_sync_2026-08-24"
