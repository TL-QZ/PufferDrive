...
# Render selected failures from an existing synced-baseline CARLA evaluation.
#
# Usage:
#   CUDA_VISIBLE_DEVICES=0 ./project/baseline_run_sync_2026-08-24/render/render_eval_failures.sh 0 carla
#   CUDA_VISIBLE_DEVICES=1 ./project/baseline_run_sync_2026-08-24/render/render_eval_failures.sh 1 nuplan_single offroad
#   CUDA_VISIBLE_DEVICES=2 ./project/baseline_run_sync_2026-08-24/render/render_eval_failures.sh 2 nuplan_multi collision 10
